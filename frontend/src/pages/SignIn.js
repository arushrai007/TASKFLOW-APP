      ...
      <div className="w-full max-w-md">
        <div className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-xl rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700 p-8">
          <div className="text-center mb-8">
            ...
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>Welcome Back</h2>
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-600 dark:text-gray-400">
              ...
              <Link to="/signup" className="text-teal-600 hover:text-teal-700 dark:text-teal-400 dark:hover:text-teal-300 font-medium" data-testid="signup-link">
                Sign Up
              </Link>
            </p>
          </div>
